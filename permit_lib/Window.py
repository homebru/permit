...
import logging
logger = logging.getLogger('permit_lib')

from . helpers import get_builder, show_uri, get_help_uri

# This class is meant to be subclassed by PermitWindow.  It provides
...
class Window(Gtk.Window):
    ...
    def __new__(cls):
        ...
        Returns a fully instantiated BasePermitWindow object.
        """
        builder = get_builder('PermitWindow')
        new_object = builder.get_object("permit_window")
    ...
    def finish_initializing(self, builder):
        ...
        and creating a PermitWindow object with it in order to finish
        initializing the start of the new PermitWindow instance.
        """
        ...
        self.settings = Gio.Settings("net.launchpad.permit")
